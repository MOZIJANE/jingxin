...
def apply(taskId, mapId, loc,filterFunc,payload=None,timeout=15):
	exclude = []
	while True:
		param = {}
		param['loc'] = loc.strip()
...
def moveJackup(agvId,loc,finishCallback,paramObj,stepCallback=None,use_pgv=False,pgv_type =1):
...
def getAgvStatus2(agvId,mapId):
	param = {}
	param['agv'] = agvId
	param['mapId'] = mapId
	return _http_get(url + '/api/agv/agvStatus', param)
