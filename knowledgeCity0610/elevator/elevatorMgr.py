...
class elevatorInfo:
	...
	def gofloor(self,floor):
		return elevatorControl.b4clicked(self.ip,self.port,floor)

	def status(self):
		return elevatorControl.b3clicked(self.ip, self.port)


	def open(self):
		return elevatorControl.b8clicked(self.ip, self.port)

	def close(self):
		return elevatorControl.b9clicked(self.ip, self.port)
