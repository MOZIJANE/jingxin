...
if __name__ == '__main__':
	...
	#math.radians角度转弧度
	#math.degrees弧度转角度
	print (math.radians(10),math.radians(5),math.degrees(0.2))
	targetList4 = [
					{"id": "9","operation": "JackLoad"},
					{"id": "2","operation": "JackUnload"},
					{"id": "20","operation": ""},
					{"id": "2","operation": "JackLoad"},
					{"id": "9","operation": "JackUnload"},
					{"id": "1","operation": ""}
				] 
	targetList5 = [
					{"id": "5","operation": ""},
	...
	# agvApi.init("feed1")
	# test_agv66("test20210201",targetList4)
	
	# agvApi.init("feed2")
	# test_agv66("test0305",targetList5)
