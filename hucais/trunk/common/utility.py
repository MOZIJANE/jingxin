...
def np2str(array):
	...
	s = str(array)
	np.set_printoptions(threshold=old["threshold"])
	return s
	
	
#numpy字符串转成numpy数组, 这个转换会损失精度 
def str2np(ss):
	aa = []
	cur = aa
	parent = None
...
def exit(signum, frame):
	import log
	import traceWriter
	traceWriter.addEvent("sigal",{"number":signum,"pid":os.getpid()})
...
def teststr2np(): 
	ss = """[[ 1.63701370e-01 -1.10181711e+00]
		 [ 1.69466824e-01 -1.11033141e+00]
		 [ 1.74876426e-01 -1.12479866e+00]
		 [ 1.80520887e-01 -1.13824246e+00] 
		 [ 9.24731513e-01 -1.53954384e+00]
		 [ 9.36894999e-01 -1.54297348e+00]
		 [ 9.49528047e-01 -1.54722695e+00]
		 [ 9.60583515e-01 -1.54774141e+00]
		 [ 9.71250481e-01 -1.54727084e+00]
		 [ 9.82358715e-01 -1.54763455e+00]
		 [ 2.14420735e-01  6.91512652e-01]
		 [ 2.07117642e-01  7.37119802e-01]
		 [ 1.95967275e-01  8.25535825e-01]
		 [ 1.89671672e-01  8.43088396e-01]]""" 
	aa = str2np(ss) 
	print(np2str(aa))
