...
# jack start
@scadaUtility.get('/api/agv/jackupOld')
def urlJackupOld():
...
@scadaUtility.get('/api/agv/jackdownOld')
def urlJackdownOld():
	agvId= webutility.get_param("agv")
	timeout= webutility.get_param_int("timeoutSec",90)
	loc = webutility.get_param("loc")
	return jackMgr.jackDownOld(agvId=agvId, timeout=timeout,loc=loc)
...
@scadaUtility.get('/api/agv/checkInitStatus')
def urlcheckInitStatus():
	agvId= webutility.get_param("agv")
	timeout= webutility.get_param_int("timeoutSec",90)
