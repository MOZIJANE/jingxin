...
def jackUpOld(agvId,timeoutSec=90,loc=None):
	return _jack('/api/agv/jackupOld', agvId,timeoutSec,loc)

def jackDownOld(agvId,timeoutSec=90,loc=None):
	return _jack('/api/agv/jackdownOld', agvId,timeoutSec,loc)
...
def checkInitStatus(agvId,timeoutSec=90):
	return _jack('/api/agv/checkInitStatus', agvId,timeoutSec)
