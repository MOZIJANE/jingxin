...
def moveJackup(agvId, loc, finishCallback, paramObj, stepCallback=None, use_pgv=False):
...
def _checkFinish():
	...
	while not utility.is_exited():
		try:
			...
			for t in rr: 
				try:
					#print("****************方法类型：",type(t.finishCallback))
